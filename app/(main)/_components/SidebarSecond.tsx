...
const SidebarButton = ({ icon: Icon, name }: { icon: any; name: string }) => (
  <button className="flex w-full items-center gap-3 rounded-lg p-3 px-4 text-gray-500 transition-all duration-300 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 hover:text-white">
    <Icon size={20} />
    <span>{name}</span>
  </button>
);
...
const SidebarLink = ({
  ...
  <Link
    href={href}
    className={cn(
      "flex w-full items-center gap-3 rounded-lg p-3 px-4 text-gray-500 transition-all duration-300 hover:bg-gradient-to-r hover:from-blue-500 hover:to-purple-500 hover:text-white",
      isActive && "bg-gradient-to-r from-blue-500 to-purple-500 text-white",
    )}
  >
    <Icon size={20} />
    <span>{name}</span>
