...
const SidebarLink = ({
  ...
  <Link
    href={href}
    className={cn(
      "flex w-full items-center gap-3 rounded-xl p-3 px-4 text-gray-400 transition-all duration-300 hover:bg-yellow-300 hover:text-black",
...
function SidebarSecond() {
  ...
  return (
    <aside className="fixed flex h-screen w-64 flex-col gap-5 bg-gradient-to-b from-gray-900 to-gray-800 p-6 shadow-xl">
      ...
      <div className="mt-auto flex flex-col items-center gap-3 rounded-xl bg-yellow-300 p-4 shadow-xl">
